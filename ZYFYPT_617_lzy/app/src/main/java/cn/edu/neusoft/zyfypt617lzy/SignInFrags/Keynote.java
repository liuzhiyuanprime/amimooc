...
public class Keynote extends Fragment {
    ...
    public Keynote(String sessionid){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerView_tware);
        ...
        if (getActivity() != null) {
            ...
            Call<ResponseBody> call = service.getArticleList("tware", "1",sessionid );
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    try {
                        ...
                        adapter.setArticleList(articleList,"tware");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
